...
class StoreOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Frames and art live in separate variant tables with independent
            // auto-increment ids, so the id alone is ambiguous — the client must
            // say which catalogue the line came from.
            'items.*.itemType' => ['required', 'string', 'in:frame,art'],
